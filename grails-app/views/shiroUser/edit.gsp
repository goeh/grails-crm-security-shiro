<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <title><g:message code="shiroUser.edit.title" default="Edit User - {1}" args="[entityName, shiroUser]" /></title>
</head>
<body>

  <div class="dialog">
    <h1><g:message code="shiroUser.edit.title" default="Edit User - {1}" args="[entityName, shiroUser]" /></h1>
  ...
  <g:hasErrors bean="${shiroUser}">
    ...
    <g:form method="post"  name="inputForm">
      <input type="hidden" name="id" value="${shiroUser?.id}" />
      <input type="hidden" name="version" value="${shiroUser?.version}" />
      ...
      <div class="golden-right">
        ...
        <fieldset>
          ...
          <g:each in="${roleList}" var="role" status="i">
            ...
            <input type="checkbox" name="role_${role.id}" ${(shiroUser.roles*.shiroRole).contains(role) ? 'checked="checked"' : ''}/>
      ...
      <div class="buttons">
        <crm:button class="positive" action="update" icon="disk" message="shiroUser.button.update.label"/>
        <crm:button class="negative" action="delete" icon="delete" message="shiroUser.button.delete.label" confirm="true"/>
      </div>
