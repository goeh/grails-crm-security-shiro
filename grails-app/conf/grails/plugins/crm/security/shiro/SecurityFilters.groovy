...
import grails.plugins.crm.core.CrmTenantFilters
...
class SecurityFilters {
    ...
    def onNotAuthenticated(subject, filter) {
        ...
        def contentType = filter.request.contentType
        if (filter.request.xhr || contentType?.equalsIgnoreCase("text/xml") || contentType?.equalsIgnoreCase("application/json")) {
